...
const EditStudent = () => {
  ...
  const [student, setStudent] = useState({
    ...
    prob_depresion: "",
    intervalo_diagnostico_modelo: "", // Nuevo campo
    ultima_interaccion: "", // Nuevo campo
    objetivos_terapeuticos: "", // Nuevo campo
  });
        ...
        <div className="bg-white p-6 rounded-lg shadow-md">
          <form onSubmit={handleSubmit}>
            <div className="space-y-4">
              ...
              {/* Nuevos campos */}
              <div>
                <label htmlFor="intervalo_diagnostico_modelo" className="block text-lg font-medium text-gray-700">Intervalo Diagnóstico Modelo (días)</label>
                <input
                  type="number"
                  id="intervalo_diagnostico_modelo"
                  name="intervalo_diagnostico_modelo"
                  value={student.intervalo_diagnostico_modelo || ""}
                  onChange={handleChange}
                  className="w-full p-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-600"
                />
              </div>
              ...
              <div>
                <label htmlFor="ultima_interaccion" className="block text-lg font-medium text-gray-700">Última Interacción</label>
                <input
                  type="date"
                  id="ultima_interaccion"
                  name="ultima_interaccion"
                  value={student.ultima_interaccion || ""}
                  onChange={handleChange}
                  className="w-full p-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-600"
                />
              </div>
              ...
              <div>
                <label htmlFor="objetivos_terapeuticos" className="block text-lg font-medium text-gray-700">Objetivos Terapéuticos</label>
                <textarea
                  id="objetivos_terapeuticos"
                  name="objetivos_terapeuticos"
                  value={student.objetivos_terapeuticos || ""}
                  onChange={handleChange}
                  rows="4"
                  className="w-full p-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-600"
                />
